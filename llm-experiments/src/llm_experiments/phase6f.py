...
DEFAULT_BASELINE_PREDICTIONS = Path("statistical-baseline/outputs/phase6c3_synthetic_smoke_consolidated/phase6f_evaluation_ready_baseline_predictions.csv")
...
DEFAULT_BASELINE_CONFIG = Path("statistical-baseline/config/phase6c_baseline_models.json")
