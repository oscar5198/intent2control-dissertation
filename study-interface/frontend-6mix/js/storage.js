...
window.StudyApp.storage = (function () {
  var namespace = "intent2control.study.6mix.dev.";
  var documentedDevelopmentKeys = [
    ...
    "audio.played.practice.practice_version_f",
    ...
    "experimental.firstPlay.trial1.version_f",
    ...
    "audio.played.experimental.trial1.version_f",
