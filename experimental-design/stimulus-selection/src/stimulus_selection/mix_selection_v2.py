...
def _load_v2_config(config_path: str | Path) -> dict[str, object]:
    ...
    if not isinstance(cfg, dict):
        raise ValueError("experimental-design/stimulus-selection/config/stimulus_selection.yaml is missing mix_selection_v2.")
...
def _write_reports(
    ...
    report_lines.extend([
        ...
        "- Location: `experimental-design/stimulus-selection/supporting-analysis/04_mix_selection_v2/candidate_pool_previews/`.",
    ...
    (reports / "v1_to_v2_method_change.md").write_text(
        "\n".join([
            ...
            "",
            "The v1 folder has been preserved unchanged at `experimental-design/stimulus-selection/supporting-analysis/archive/medoid_contrast_legacy/04_mix_selection/`.",
            "",
        ]),
        encoding="utf-8",
    )
