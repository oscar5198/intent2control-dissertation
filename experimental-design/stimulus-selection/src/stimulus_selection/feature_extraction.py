...
def write_report(
    ...
    lines.extend([
        ...
        "## Implementation",
        "",
        "- Vendored implementation: `experimental-design/stimulus-selection/src/stimulus_selection/third_party/diffmst_features/`",
    ...
    lines.extend([
        ...
        f"- Config hash: `{_hash_file(Path('experimental-design/stimulus-selection/config/stimulus_selection.yaml'))}`",
        f"- Feature extraction source hash: `{_hash_file(Path('experimental-design/stimulus-selection/src/stimulus_selection/feature_extraction.py'))}`",
        f"- Vendored feature source hash: `{_hash_file(Path('experimental-design/stimulus-selection/src/stimulus_selection/third_party/diffmst_features/features.py'))}`",
        "",
        "## Stage 4 Readiness",
        "",
