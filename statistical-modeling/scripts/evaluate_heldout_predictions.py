...
SUMMARY_PATH = REPO_ROOT / "statistical-modeling" / "data" / "real" / "real_data_summary.csv"
MANIFEST_PATH = REPO_ROOT / "statistical-modeling" / "data" / "real" / "real_cleaning_manifest.json"
