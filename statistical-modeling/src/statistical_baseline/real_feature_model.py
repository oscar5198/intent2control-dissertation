...
CURATED_DATA_DIR = PROJECT_ROOT / "data/processed"
ANCILLARY_DATA_DIR = PROJECT_ROOT / "statistical-modeling/data/real"
STIMULUS_OUTPUT_DIR = PROJECT_ROOT / "statistical-modeling/outputs/stimulus-model"
OUTPUT_DIR = PROJECT_ROOT / "statistical-modeling/outputs/feature-model"
FIGURE_DIR = OUTPUT_DIR / "figures"
RATINGS_PATH = CURATED_DATA_DIR / "ratings_final.csv"
PREFERENCES_PATH = CURATED_DATA_DIR / "trial_preferences_final.csv"
MANIFEST_PATH = ANCILLARY_DATA_DIR / "real_cleaning_manifest.json"
SUMMARY_PATH = ANCILLARY_DATA_DIR / "real_data_summary.csv"
PARTICIPANTS_PATH = CURATED_DATA_DIR / "participants_final.csv"
FEATURE_TABLE_PATH = PROJECT_ROOT / "statistical-modeling/outputs/acoustic-features/final_20_stimulus_feature_table.csv"
