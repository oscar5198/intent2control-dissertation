...
OUTPUT_DIR = PROJECT_ROOT / "statistical-modeling/outputs/stimulus-model"
...
TIES_PATH = ANCILLARY_DATA_DIR / "real_trial_ties_long.csv"
VALIDATION_PATH = ANCILLARY_DATA_DIR / "real_data_validation.csv"
