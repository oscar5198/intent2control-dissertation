...
RAW_SOURCE = PROJECT_ROOT / "statistical-baseline/data/real/raw/listening_preference_responses_33_immutable.xlsx"
DOWNLOAD_SOURCE = Path(os.environ["REAL_DATA_DOWNLOAD_SOURCE"]) if os.environ.get("REAL_DATA_DOWNLOAD_SOURCE") else RAW_SOURCE
OUTPUT_DIR = PROJECT_ROOT / "statistical-baseline/data/real"
NOTEBOOK_PATH = PROJECT_ROOT / "statistical-baseline/notebooks/_06_real_data_cleaning.ipynb"
...
FEATURE_TABLE = PROJECT_ROOT / "statistical-baseline/outputs/feature_exploration/final_20_stimulus_feature_table.csv"
    ...
    stale_targets = [
        {
            ...
            "notebook": "statistical-baseline/notebooks/_07_real_stimulus_model.ipynb",
            "output_path": "statistical-baseline/outputs/real_stimulus_model",
        },
        {
            "phase": "Phase 3B final acoustic feature model",
            "notebook": "statistical-baseline/notebooks/_08_real_feature_model.ipynb",
            "output_path": "statistical-baseline/outputs/real_feature_model",
        },
        {
            "phase": "Phase 3 held-out statistical evaluation",
            "notebook": "statistical-baseline/notebooks/_09_real_heldout_evaluation.ipynb",
            "output_path": "statistical-baseline/outputs/real_heldout_evaluation",
        },
    ]
...
def run_cleaning() -> dict[str, Any]:
    ...
    manifest = {
        ...
        "outputs": {
            "ratings": "statistical-baseline/data/real/real_ratings_clean.csv",
            "participants": "statistical-baseline/data/real/real_participants_clean.csv",
            "trial_preferences": "statistical-baseline/data/real/real_trial_preferences.csv",
            "ties": "statistical-baseline/data/real/real_trial_ties_long.csv",
            "submission_audit": "statistical-baseline/data/real/real_submission_audit.csv",
            "exclusion_log": "statistical-baseline/data/real/real_exclusion_log.csv",
            "validation": "statistical-baseline/data/real/real_data_validation.csv",
            "summary": "statistical-baseline/data/real/real_data_summary.csv",
            "schema_audit": "statistical-baseline/data/real/real_schema_audit.csv",
            "metadata_audit": "statistical-baseline/data/real/real_participant_metadata_audit.csv",
            "downstream_stale": "statistical-baseline/data/real/real_downstream_stale_outputs.csv",
            "manifest": "statistical-baseline/data/real/real_cleaning_manifest.json",
        },
        ...
        "transformations": [
            "Copied immutable raw workbook into statistical-baseline/data/real/raw if absent.",
