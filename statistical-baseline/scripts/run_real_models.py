...
dataset under statistical-baseline/data/real/.
"""
...
SUMMARY_PATH = REAL_DATA_DIR / "real_data_summary.csv"
PARTICIPANTS_PATH = REAL_DATA_DIR / "real_participants_clean.csv"
RATINGS_PATH = REAL_DATA_DIR / "real_ratings_clean.csv"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the final full-data real Bayesian statistical baseline models.",
    )
